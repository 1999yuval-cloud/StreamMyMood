...
def logo_html(width=680):
    if LOGO_B64:
        return (f'<div style="text-align:center;margin:0;padding:0;line-height:0">'
...
/* But restore line-height for text */
.stMarkdown p span, .stMarkdown div span {{
  line-height: 1.5 !important;
}}
/* Remove iframe borders that add space */
iframe {{
...
def screen_welcome():
    ...
    st.markdown(f"""
    <div class="center" style="margin-bottom:0.1rem;margin-top:-2.5rem">
